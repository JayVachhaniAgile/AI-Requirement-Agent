...
export default function ProjectWorkspace() {
  ...
  const canRestart = ["CREATED", "FAILED", "WAITING_FOR_USER", "PAUSED", "COMPLETED"].includes(project.status);
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          {canRestart && (
            ...
            >
              <Play className="h-4 w-4" /> {isCreated ? "Start Analysis" : project.status === "COMPLETED" ? "Generate Documents" : isPaused ? "Resume Analysis" : "Resume Analysis"}
            </Button>
          )}
          {isRunning && (
            <>
