/**
 * Shared output contract prepended to every agent's system prompt (fixed
 * prompts doc). Note: the doc's inline code spans are single-quoted here so
 * they can live inside a TS template literal.
 */
