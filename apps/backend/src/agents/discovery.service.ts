...
const Schema = z.object({
  ...
  userGoals: z.array(z.object({ externalId: z.string().optional().default(""), title: z.string(), description: z.string() })),
  users: z.array(z.object({ externalId: z.string().optional().default(""), title: z.string(), description: z.string() })),
